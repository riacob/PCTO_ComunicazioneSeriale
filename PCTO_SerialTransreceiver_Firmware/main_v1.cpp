...
void decodeHDLC(char *dataBuffer, HDLCData* dataStruct, bool dataReady = true)
{
  ...
  */
  ...
  /*
  lcd.setCursor(2,1);
  lcd.print((char)dataStruct->recFCS[0]);
  lcd.setCursor(3,1);
  lcd.print((char)dataStruct->recFCS[1]);
  lcd.setCursor(5,1);
  lcd.print((char)dataStruct->calcFCS[0]);
  lcd.setCursor(6,1);
  lcd.print((char)dataStruct->calcFCS[1]);
  */
  ...
  */
  ...
  Serial.print(dataStruct->dataValid);
  Serial.println("");
  */
